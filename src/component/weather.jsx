                                        ...
                                        </form>
                                        {
                                            this.state.weatherRep.map((rep) =>
                                                <>
                                                    ...
                                                    <h1 className="card-text">Weather in {this.state.cityName}</h1>
                                                    <p className="card-text temp mb-0">{Math.round(this.state.temperature - 273.15)} &#8451;</p>
                                                    <div className="desc">
                                                    <span>{this.state.desc.description}</span>
                                                    <img src={`https://openweathermap.org/img/wn/${rep.icon}.png`} alt="" /></div>
                                                    <div className="py-2">
                                                    <span><i class="fas fa-tint"></i>  {this.state.humidity}% </span> | <span> <i class="fas fa-wind"></i> {this.state.wind}Km/h</span>
                                        
                                                    </div>

                                                    <p className="pt-4"> <i class="far fa-calendar-alt"></i> {this.state.day} {this.state.date}</p>
